<template>
  <div class="flex flex-col md:flex-row-reverse mt-6 lg:mt-20 px-4 md:px-20">
    <div class="bg-black w">
      <img
        src="/images/nigga-wheelchair.webp"
        alt="macbook15"
        class="w-[100%] h-full object-cover"
      />
    </div>
    <div
      class="flex flex-col bg-[#13544e] w-full md:w-3/1 md:rounded-l-lg md:mt-0"
    >
      <div class="mt-10 ml-10 font-bold text-2xl text-white">
        Enterprise Suite
      </div>
      <div class="mt-6 ml-10 font-bold text-5xl text-white">This is how</div>
      <div class="mt-2 ml-10 font-bold text-5xl text-[#90e6b3]">
        good companies <br />
        find good company.
      </div>
      <div class="mt-6 ml-10 text-lg text-white">
        Access the top 1% of talent on Upwork, and a full suite of hybrid <br />
        workforce management tools. This is how innovation works now.
      </div>
      <div class="mt-3 ml-10 text-sm text-white">
        <div class="flex flex-row mt-4">
          <svg
            class="w-6 h-6 text-[#90e6b3]"
            aria-hidden="true"
      ...
      <div class="ml-10 text-sm text-white">
        <div class="flex flex-row mt-4">
          <svg
            class="w-6 h-6 text-[#90e6b3]"
            aria-hidden="true"
      ...
      <div class="ml-10 mb-4 text-sm text-white">
        <div class="flex flex-row mt-4">
          <svg
            class="w-6 h-6 text-[#90e6b3]"
            aria-hidden="true"
        ...
        <WhiteAppButton class="mt-4 mb-8">Learn more</WhiteAppButton>
      </div>
    </div>
  </div>
</template>
