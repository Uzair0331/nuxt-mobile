...
<template>
  <div class="flex flex-col md:flex-row justify-between px-4 md:px-20 py-5">

    <div class="flex justify-center px-4 md:px-20 py-10 bg-[#f2f7f1] rounded-[12px] ">
      <img width="450" height="350" class="transition duration-500 ease-in-out transform hover:scale-105"
        src="/images/firstcard.webp" alt="firstcard" />
    </div>
    <div class="flex flex-col px-4 md:px-20 ">
      <h1 class="font-semibold mt-4 text-[40px] ">Up your work game, it’s easy</h1>
      <div class="flex flex-row  mt-4">
        <svg class="w-6 h-6 text-black mt-1 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div class="flex flex-col ml-3 ">
          <h1 class="font-semibold  text-[20px] ">No cost to join</h1>
          <h1 class="font-semibold  text-[12px] ">Register and browse professionals, explore projects, or even book a
            consultation.</h1>
        </div>
      ...
      <div class="flex flex-row  mt-4">
        ...
        <div class="flex flex-col ml-3 ">
          <h1 class="font-semibold  text-[20px] ">Post a job and hire top talent</h1>
          <h1 class="font-semibold  text-[12px] ">Finding talent doesn’t have to be a chore. Post a job or we can search
            for you!
      ...
      <div class="flex flex-row  mt-4">
        ...
        <div class="flex flex-col ml-3 ">
          <h1 class="font-semibold  text-[20px] ">Work with the best—without breaking the bank
          </h1>
          <h1 class="font-semibold  text-[12px] ">Upwork makes it affordable to up your work and take advantage of low
            transaction rates.</h1>
        </div>

      </div>
      <div class="flex flex-row gap-10">
        <AppButton size="sm" rounded="2xl"
          class="px-3 py-1 lg:w-[30%] w-full mt-8 transition duration-500 ease-in-out transform hover:scale-105 ">
          Sign up for free
        </AppButton>
        <AppButtonTwo size="sm" rounded="2xl"
          class="px-2 py-3 w-full md:w-[30%] mt-8 transition duration-500 ease-in-out transform hover:scale-105">Learn
          how to hire</AppButtonTwo>
      </div>
